...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial-www v0.7.3
...
require (
	...
	github.com/aaronland/go-http/v3 v3.0.1 // indirect
	...
	github.com/whosonfirst/go-whosonfirst-export/v3 v3.1.0 // indirect
